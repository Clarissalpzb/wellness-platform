...
export async function GET() {
  try {
    ...
    const org = await db.organization.findUnique({
      where: { id: orgId },
      select: { id: true, name: true, slug: true, logo: true, settings: true, monthlyOperatingCost: true, stripeAccountId: true, stripeOnboardingComplete: true, onboardingCompleted: true },
    });
